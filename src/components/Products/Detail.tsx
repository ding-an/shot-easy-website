	...
	return (
		<>
			<div className='mt-6 flex flex-nowrap gap-3 overflow-x-auto xl:mt-0 xl:flex-1 xl:gap-5'>
				{products.map(i => (
					<div className='w-[152px] flex-shrink-0 rounded-2xl border border-solid border-white/10 bg-[#222b38] p-3 text-white/94 xl:h-[240px] xl:w-[200px] xl:max-w-[30%] xl:rounded-2.5xl xl:p-4'>
