...
export default function Remover() {
        ...
        try {
          ...
          if (response.ok) {
            ...
            Modal.warning({
              ...
              content: (
                <>
                  The API usage limit. Please go to{" "}
                  <a
  ...
  const toDownload = () => {
    ...
    toDownloadFile(imgbase64, "ImgTools.png");
  ...
  return (
    <>
      ...
      <div
        className={cn(
          "rounded-md shadow-lg border-t overflow-hidden border-t-gray-600 antialiased",
          isGrid ? "tr" : "polka"
        )}
      >
              ...
              {photoUrl && (
                <div
                  className={cn(
                    ...
                    transparentUrl &&
                      "opacity-0 absolute top-0 left-0 transition-all z-10",
                    showOrigin && "opacity-100"
                  )}
                >
                  <img src={photoUrl} className="w-full object-cover" />
                </div>
              )}
              {transparentUrl && (
                <div className="overflow-hidden w-auto relative z-[9]">
                  <img src={transparentUrl} className="w-full" />
                </div>
              )}
              {transparentUrl && (
                <div
