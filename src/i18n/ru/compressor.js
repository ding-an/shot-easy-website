export default {
  ...
  vsTitle: "ImgTools Компрессор vs TinyPNG Компрессор",
  vsTitle1: "ImgTools Компрессор",
  vsTitle2: "TinyPNG Компрессор",
  vsCont1:
    "Использование нативных библиотек C++: libimagequant / libpng / zlib, скомпилированных в WebAssembly, используемых в веб-приложениях.",
  vsCont2: "Сжатие на уровне памяти с помощью нативного кодирования.",
  vsCont3:
    "После загрузки ресурсов, чисто локальное использование в браузере, без необходимости загрузки на сервер",
  vsCont4:
    "Бесплатно, без ограничения размера, без ограничения количества, поддержка многоуровневых папок",
  vsCont5:
    "Чисто локальный и открытый исходный код, обеспечивающий конфиденциальность и безопасность.",
  vsCont6:
    "Веб-сайт TinyPNG достигает сжатия изображений с помощью использования интеллектуальных алгоритмов сжатия. Эти алгоритмы, основанные на технологиях глубокого обучения и машинного обучения, могут обнаруживать и удалять ненужные детали и избыточную информацию в изображениях, тем самым уменьшая размер файлов изображений.",
  vsCont7:
    "Алгоритм сжатия TinyPNG в основном обнаруживает неважные пиксели в изображениях и заменяет их более простыми представлениями, тем самым уменьшая размер файла.",
  vsCont8:
    "TinyPNG поддерживает загрузку нескольких изображений одновременно, обрабатывая до 20 изображений одновременно.",
  vsCont9:
    "Поддерживает только форматы изображений PNG, JPEG, WebP, не поддерживает GIF, SVG и другие форматы",
  vsCont10:
    "Максимальная поддержка 5 МБ на изображение, могут быть ограничения для изображений сверхвысокого разрешения",
  vsCont11:
    "Риск для конфиденциальности, пользователям необходимо загружать изображения на серверы TinyPNG для сжатия.",
};
