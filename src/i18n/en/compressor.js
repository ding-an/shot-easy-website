export default {
  ...
  description:
    "Free online image compressor for faster websites! Reduce the file size of your WEBP, JPEG, and PNG images with compression implementation based on Webassembly.",
  tip: "Not uploaded, compress in browser with Webassembly",
  online: "Compress Images Online",
  onlineCont1:
    "Free online image compressor for faster websites! Reduce the file size of your WEBP, JPEG, and PNG images with compression implementation based on Webassembly.Batch image compression, supports JPG/JPEG/PNG/WEBP/GIF/SVG/AVIF formats.",
  onlineCont2:
    "it is purely local compression without any server-side logic, it is completely safe.",
  ...
  vsCont3:
    "After resource loading, pure browser-local usage, no upload required",
